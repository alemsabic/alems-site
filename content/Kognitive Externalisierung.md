...
[^2]: **Exogramm** (griech. *exo* = außen, *gramma* = Schrift): Gedächtnisspur außerhalb des Gehirns (z.B. Zettel). Gegensatz: **Engramm** (innere Gedächtnisspur). [@donald_1991]

[^3]: **Epistemisch** (griech. *episteme* = Wissen): Eine Handlung, die der Erkenntnis dient (Stein drehen, um zu sehen). Gegensatz: Pragmatisch (Stein legen, um zu bauen). [@kirsh_maglio_1994]
