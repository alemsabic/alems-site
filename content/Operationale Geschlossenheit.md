...
Ein System – eine Zelle, ein Bewusstsein, ein Zettelkasten – besitzt keine "Türen", durch die Informationen unverändert hineinspazieren. Es operiert ausschließlich innerhalb seiner Grenzen, mit seinen eigenen Elementen. Nur so kann es überhaupt zwischen System und Umwelt unterscheiden.[^1] [@luhmann_1984]
...
[^2]: **Autopoietisches System** (griech. *autos* = selbst, *poiein* = machen): Ein System, das sich selbst erzeugt. Es operiert geschlossen. Beispiel: Das Bewusstsein produziert Gedanken aus Gedanken. [@varela_1979]
