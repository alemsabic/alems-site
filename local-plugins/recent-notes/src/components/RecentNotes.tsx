...
export default ((userOpts?: Partial<RecentNotesOptions>) => {
  const RecentNotes: QuartzComponent = ({
    ...
    // ale.ms/gpunkt.org customization: only show on the index page (v4's
    // ConditionalRender(RecentNotes, condition: slug === "index")).
    ...
    const pages = filterListedPages(allFiles as RecentNotesPluginData[])
      ...
      // ale.ms/gpunkt.org customization: never list the index page itself.
